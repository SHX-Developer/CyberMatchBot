...
from app.models import User, UserChat, UserLike, UserMessage, UserSubscription
...
class InteractionRepository:
    ...
    async def create_message(self, from_user_id: int, to_user_id: int, text: str) -> UserMessage:
        ...
        chat = await self.session.scalar(chat_stmt)
        if chat is None:
            chat = UserChat(participant_1_id=participant_1_id, participant_2_id=participant_2_id)
